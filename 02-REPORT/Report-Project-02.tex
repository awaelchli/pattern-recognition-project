...
\begin{figure}[htb]
	...
	\caption{RTF kernel: C vs. accuracy}
	\label{fig:results-own}
\end{figure}
\begin{figure}[htb]
	\centering
	\includegraphics[width=10cm]{{images/svm/ass2_svm_im2}.png}
	\caption{RTF kernel: gamma vs. accuracy}
	\label{fig:results-own}
\end{figure}
These are the results for the RTF kernel. The best combination of C and $\gamma$ turned out to be $C = 2^{1.\overline{6}}$ and $\gamma = 2^{-5}$. With this combination, we achieve an overall accuracy of \textbf{95.136576} percent.\\
